...
const Content = (props: Props) => {
  ...
  return (
    <div>
      ...
      {/* Characters */}
      <div className='pt-10'>
        <Characters openDetails={props.openDetails} />
      </div>
      ...
      {/* Card password */}
      <div className='text-center m-auto w-2/3 mobile:w-5/6 pt-20 pb-64 h-full my-16 px-16'
        style={divStyle}>
        <h2 className='text-neutral-700'>HAR NOLLAN HITTAT ETT LÖSENORD?</h2>
        <Card_passwords />
      </div>
